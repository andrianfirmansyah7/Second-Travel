...
<br>
  ...
  <div class="col-md-12">
  <center>
	<a href="<?php echo base_url()?>kereta/cetak_tiket/<?php echo $id?>" class="btn btn-primary" style="background-color: white;color:#2980b9;position:center">Cetak Tiket</a><br></center>
	<br>
  </div>
</div>
</div>
